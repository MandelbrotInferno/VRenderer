...
int main()
{
	...
	GhazaEngine::VRenderer::SDL_WindowWrapper lv_window{};
	std::unique_ptr<GhazaEngine::VRenderer::Renderer> lv_renderer = std::make_unique<GhazaEngine::VRenderer::Renderer>();
	...
	try {
		...
		lv_renderer->Init(lv_window.m_window, lv_sceneData);
