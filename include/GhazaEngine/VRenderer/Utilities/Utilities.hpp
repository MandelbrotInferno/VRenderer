...
#include "GhazaEngine/VRenderer/VulkanWrappers/VulkanSubmissionSync.hpp"
...
namespace GhazaEngine
{
	namespace VRenderer
	{
		...
		namespace Utilities
		{
			...
			std::vector<VkPipeline> GenerateGraphicsPipelines(VkDevice l_device, const std::span<GhazaEngine::VRenderer::Utilities::VulkanGraphicsCreateInfo> l_graphicsCreateInfoHelpers);
